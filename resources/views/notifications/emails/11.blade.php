                                                        ...
                                                        <tr>
                                                            <td class="pad">
                                                                <div
                                                                    ...
                                                                    <p style="margin: 0; margin-bottom: 2px;"><span
                                                                            style="color: #384860;">(Buyer name) ordered
                                                                            for (product name) from (store name). Please
                                                                            keep track of the product delivery process
                                                                            and resolve issues accordingly.</span><span
