                                ...
                                <td>
                                    <table align="center" border="0" cellpadding="0" cellspacing="0" class="row-content"
                                        ...
                                        <tbody>
                                            <tr>
                                                <td class="column column-1"
                                                    style="mso-table-lspace: 0pt; mso-table-rspace: 0pt; font-weight: 400; text-align: left; padding-left: 08px; padding-right: 08px; vertical-align: middle; padding-top: 5px; padding-bottom: 5px; border-top: 0px; border-right: 0px; border-bottom: 0px; border-left: 0px;"
                                                    width="100%">
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                            ...
                                            <tr>
                                                <td class="column column-1"
                                                        ...
                                                        <tr>
                                                            <td class="pad">
                                                                <div
                                                                    ...
                                                                    <p style="margin: 0; margin-bottom: 2px;"><span
                                                                            style="color: #121a26;"><strong>Hi
                                                                                (name),</strong></span></p>
                                                                    <p style="margin: 0; margin-bottom: 2px;"> </p>
                                                                    <p style="margin: 0; margin-bottom: 2px;"><span
                                                                            style="color: #384860;">You just added a
                                                                            product to your cart.</span><span
                                                                            style="color: #384860;"></span></p>
                                                                    <p style="margin: 0; margin-bottom: 2px;"> </p>
                                                                    <p style="margin: 0; margin-bottom: 2px;">
                                                                        <strong><span style="color: #384860;">Click to
                                                                                continue shopping</span></strong>
                                                                    </p>
                                                                    <p style="margin: 0; margin-bottom: 2px;"> </p>
                                                                    <p style="margin: 0; margin-bottom: 2px;"><span
                                                                            style="color: #2969ff;">XXXXXXXXXXXX/XXXXXXXXX</span><span
                                                                            style="color: #384860;"></span><span
                                                                            style="color: #2969ff;"></span></p>
                                                                    <p style="margin: 0; margin-bottom: 2px;"> </p>
                                                                    <p style="margin: 0;"><span
                                                                            style="color: #384860;">or</span></p>
                                                                </div>
                                                            </td>
                                                        </tr>
                                                    </table>
                                                        ...
                                                        <tr>
                                                            <td class="pad"
                                                                ...
                                                                <div align="left" class="alignment">
                                                                    <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="https://www.afrikobo.com" style="height:46px;width:225px;v-text-anchor:middle;" arcsize="9%" stroke="false" fillcolor="#9a1725"><w:anchorlock/><v:textbox inset="0px,0px,0px,0px"><center style="color:#ffffff; font-family:Tahoma, Verdana, sans-serif; font-size:18px"><![endif]--><a
                                                                        ...
                                                                        target="_blank"><span
                                                                            style="padding-left:20px;padding-right:20px;font-size:18px;display:inline-block;letter-spacing:normal;"><span
                                                                                dir="ltr"
                                                                                style="word-break: break-word; line-height: 36px;">Proceed
                                                                                to checkout</span></span></a>
                                                            ...
                                                            <td class="pad">
                                                                <div
                                                                    ...
                                                                    <p style="margin: 0;"><strong><span
                                                                                style="color: #384860;">Thanks,</span></strong><br /><strong><span
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            <td class="pad"
                                                                style="padding-bottom:5px;padding-top:35px;">
                                                                <div align="center" class="alignment">
                                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                                        role="presentation"
                                                                        style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;"
                                                                        ...
                                                                        <tr>
                                                                            <td class="divider_inner"
                                                                                style="font-size: 1px; line-height: 1px; border-top: 1px solid #CDC9C6;">
                                                                                <span> </span>
                                                                            </td>
                                                                        </tr>
                                                                    </table>
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0"
                                                        class="image_block block-7" role="presentation"
                                                        style="mso-table-lspace: 0pt; mso-table-rspace: 0pt;"
                                                        width="100%">
                                                        <tr>
                                                            <td class="pad"
                                                                ...
                                                                <div align="center" class="alignment"
                                                                    style="line-height:10px"><img class="big"
                                                                        src="{{ $message->embed(resource_path("views/notifications/emails/images/CTA_information.png"))}}"
                                                        ...
                                                        <tr>
                                                            <td class="pad">
                                                                <div
                                                                    ...
                                                                    <p style="margin: 0;">This email was sent to you
                                                                        from afrikobo@email.com. If you prefer not to
                                                                        receive this type of email, don't you want more
                                                                        emails from your brand? Drop out.<br /><br />915
